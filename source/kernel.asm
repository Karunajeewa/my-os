...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to My OS Ver 0.01", 0x00

	wel1 db	'=================================================', 0x00			

	wel2 db '*********** ---------WELCOME-------- ************', 0x00 

	wel4 db ' initial Idea By : Dr.Mohan Raj Dhanagopal', 0x00

	wel5 db '-------------------------------------------------', 0x00

	wel6 db ' Version 0.01  &  Ultimate Boot Loader - Matthew Vea', 0x00

	wel7 db ' Key Words: ver | info | help | exit ', 0x00




	h_heading db '--------- Main Menu ---------', 0x00
